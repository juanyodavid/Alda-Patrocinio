...
<body>
            ...
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
                        ...
                        <a href="../principal.php" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Atrás</span>
                        </a>
					</div>
                </div>
            </div>
	...
	<!-- Edit Modal HTML -->
	<?php include("html/orden_crud/modal_edit.php");?>
	<?php include("html/orden_crud/modal_delete.php");?>
	<!-- Delete Modal HTML -->
	<script src="js/orden_script.js"></script>
</body>
</html>