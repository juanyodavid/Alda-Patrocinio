...
if ($action == 'ajax') {
	...
	$query5 = mysqli_real_escape_string($con, (strip_tags($_REQUEST['query5'], ENT_QUOTES)));
	$tables = "tarea";
	$campos = "*";
...
?>
 ...
 -->
					...
					?>
					<!-- <tr> -->
					<!-- <a href="#" id="cliente_idq" data-target="#editProductModal" class="edit" data-toggle="modal" data-fecha=""  data-facilitador="" data-id2=""  data-idm=""> para pasar multiples valores <i class="material-icons" data-toggle="tooltip" title="Editara" >assignment_ind</i></a> -->
