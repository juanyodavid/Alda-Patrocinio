...
<body>
		...
		<div class="table-wrapper">
			...
			<div class='col-sm-14 '>
				<div id="custom-search-input">
					...
					<div class="input col-md-2">
						<select name="estados_add" id="estados" class="form-control" onchange="load(1);">
							<option value="">ESTADOS</option>
							<option value="Pendiente">Pendiente</option>
							<option value="Completado">Completado</option>
							<option value="Dado de baja">Dado de baja</option>
							<option value="Solo visitado">Solo visitado</option>
	...
	<!-- Edit Modal HTML -->
	<?php include("html/reporte_crud/modal_delete.php"); ?>

	<script src="js/reporte_script.js"></script>
	<script>
		function fire() {
